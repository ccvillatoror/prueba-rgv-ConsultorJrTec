...
# Add Formatter to HandlerFlask==3.0.3
...
<head>
    ...
    <title>AWS Elastic Beanstalk - Python Sample Application</title>
    <style>
        :root {
        ...
        * {
        ...
        .hero {
            background: linear-gradient(135deg, var(--aws-squid-ink) 0%, #146EB4 100%); /* Python blue gradient */
            color: white;
            padding: 4rem 0;
            text-align: center;
        }
...
<body>
    ...
    <section class="hero">
        <div class="container">
            ...
            <p>Congratulations! Your Python application is now running on your own dedicated environment in the AWS Cloud.</p>
    ...
    <section class="section resources">
        <div class="container">
            ...
            <ul class="resource-list">
                ...
                <li class="resource-item">
                    <a href="https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/create-deploy-python-container.html" class="resource-link" target="_blank" rel="noopener noreferrer">
                        <span class="resource-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="1em" height="1em" fill="currentColor">
                ...
                <li class="resource-item">
                    <a href="https://www.python.org/doc/" class="resource-link" target="_blank" rel="noopener noreferrer">
                        <span class="resource-icon">
